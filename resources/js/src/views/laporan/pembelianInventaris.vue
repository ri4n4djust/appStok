                ...
                <div class="panel br-6">
                    <div class="custom-table panel-body p-0">
                        ...
                        <div class="d-flex flex-wrap justify-content-center justify-content-sm-start px-3 pt-3 pb-0">
                            ...
                            <h5>Daftar Pembelian Inventaris</h5>
                        ...
                        <v-client-table :data="items" :columns="columns" :options="table_option">
                            <template #tgl_spk="props"> {{ moment(props.row.tgl_spk).format("D-M-YYYY") }} </template>
...
<script setup>
    ...
    const columns = ref(['pengadaan_sysno', 'tgl_spk', 'nmSupplier', 'total', 'action']);
    const items = ref([]);
    const table_option = ref({
        ...
        sortable: ['pengadaan_sysno', 'tgl_spk', 'nmSupplier',],
        sortIcon: {
            base: 'sort-icon-none',
            up: 'sort-icon-asc',
            down: 'sort-icon-desc',
    ...
    const bind_data = () => {
        ...
        setTimeout(function() { items.value = store.getters.StateLaporanPembelianInventaris; }, 200 );
    }
